...
import com.tt.circle.app.data.Convert;
import com.tt.circle.app.data.RspBase;
import com.tt.circle.app.data.SimpleResponse;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != RspBase.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                RspBase lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();
