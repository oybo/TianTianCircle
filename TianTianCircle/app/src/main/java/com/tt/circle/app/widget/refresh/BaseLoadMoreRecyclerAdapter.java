package com.tt.circle.app.widget.refresh;
...
import com.tt.circle.app.widget.ProgressWheel;
...
public abstract class BaseLoadMoreRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter {
    ...
    public BaseLoadMoreRecyclerAdapter(Context ctx) {
        mContext = ctx;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof FooterViewHolder) {
            ...
            bindData((RecyclerViewHolder) holder, position, mList.get(position));
        ...
        if (canClickItem != null) {
            for (Integer key : canClickItem.keySet()) {
                ...
                if (inView != null && inviewListener != null) {
                    inView.setOnClickListener(new NoDoubleClickListener() {
                        @Override
                        protected void onNoDoubleClick(View v) {
